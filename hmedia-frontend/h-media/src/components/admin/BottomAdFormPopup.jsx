...
export default function BottomAdFormPopup({
  isOpen,
  onClose,
  onSubmit,
  ad,
  ...
  return new Promise((resolve) => {
    ...
    reader.onload = (event) => {
      ...
      img.onload = () => {
        ...
        // ⚠ PNG does not compress much with quality reduction
  ...
  const handlePageTypeSelect = (pageType) => {
    ...
    setErrors((prevErrors) => {
      ...
      if (adsOnPage.length >= 5) {
        newErrors.pageType = "already 5 ads uploaded in this page";
      } else {
  ...
  const formTitle = ad ? "Edit Bottom Ad" : "Add Bottom Ad";
