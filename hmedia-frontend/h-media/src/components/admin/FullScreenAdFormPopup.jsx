...
// export default function FullScreenAdFormPopup({
//   isOpen,
//   onClose,
//   onSubmit,
//   ad,
...
//   const formTitle = ad ? "Edit Full Screen Ad" : "Add Full Screen Ad";
...
//         <form id="fullscreen-ad-form" onSubmit={handleSubmit} className="p-6 space-y-6">
//           {/* Image Upload */}
//           <div>
...
export default function FullScreenAdFormPopup({
  ...
  //     if (thumbnail && !imagePreview && !imageFile && !ad) {
  //       try {
